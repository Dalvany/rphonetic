...
/// [Encoder] implementation return the primary. To get the alternate, use `encode_alternate()` method.
///
/// # Examples
///
/// ```rust
...
impl DoubleMetaphone {
    ...
    pub fn encode_alternate(&self, s: &str) -> String {
        self.double_metaphone(s, true)
    }
    ...
    /// *  `alternate` : if  ̀false` then primary codes are checked, otherwise it is the `alternate` that are compared.
    pub fn is_double_metaphone_equal(&self, value1: &str, value2: &str, alternate: bool) -> bool {
        self.double_metaphone(value1, alternate) == self.double_metaphone(value2, alternate)
    }
    ...
    /// is return, otherwise it will be the `alternate`.
    pub fn double_metaphone(&self, value: &str, alternate: bool) -> String {
...
impl Encoder for DoubleMetaphone {
    ...
    fn encode(&self, value: &str) -> String {
        self.double_metaphone(value, false)
    }
}
...
mod tests {
    ...
    fn double_metaphone_equal_test(data: Box<[(&str, &str)]>, use_alternate: bool) {
        let encoder = DoubleMetaphone::default();
        for (v1, v2) in data.into_iter() {
            if use_alternate {
                assert!(
    ...
    fn test_is_double_metaphone_equal_basic() {
        ...
        double_metaphone_equal_test(Box::new(fixture), false);
        double_metaphone_equal_test(Box::new(fixture), true);
    }
